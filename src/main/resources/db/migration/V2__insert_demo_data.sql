...
VALUES
    ...
    ('Michael',
     ...
     (SELECT customer_id
      FROM customers
      WHERE customer_name = 'Global Finance Ltd')),
    ...
    ('Sarah',
     ...
     (SELECT customer_id
      FROM customers
      WHERE customer_name = 'Tokyo Trading Co.')),
    ...
    ('James',
     ...
     (SELECT customer_id
      FROM customers
      WHERE customer_name = 'Pacific Logistics'));
...
(note_text,
 ...
 updated_by)
VALUES
    ('Initial meeting completed. Customer is interested in our enterprise solution.',
     CURRENT_TIMESTAMP,
     CURRENT_TIMESTAMP,
     (SELECT user_id
      FROM users
